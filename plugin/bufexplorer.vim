...
function! s:SelectBufByNumber(number)
	call s:Close()
	execute "b" . a:number
endfunction
...
function! s:MapKeys()
    ...
    nnoremap <script> <silent> <buffer> 0             :call <SID>SelectBufByNumber(0)<CR>
    nnoremap <script> <silent> <buffer> 1             :call <SID>SelectBufByNumber(1)<CR>
    nnoremap <script> <silent> <buffer> 2             :call <SID>SelectBufByNumber(2)<CR>
    nnoremap <script> <silent> <buffer> 3             :call <SID>SelectBufByNumber(3)<CR>
    nnoremap <script> <silent> <buffer> 4             :call <SID>SelectBufByNumber(4)<CR>
    nnoremap <script> <silent> <buffer> 5             :call <SID>SelectBufByNumber(5)<CR>
    nnoremap <script> <silent> <buffer> 6             :call <SID>SelectBufByNumber(6)<CR>
    nnoremap <script> <silent> <buffer> 7             :call <SID>SelectBufByNumber(7)<CR>
    nnoremap <script> <silent> <buffer> 8             :call <SID>SelectBufByNumber(8)<CR>
    nnoremap <script> <silent> <buffer> 9             :call <SID>SelectBufByNumber(9)<CR>
