...
" Math Operator 
hi cMathOperator            guifg=#9AC0CD  ctermfg=24
hi cMathOperator            guifg=#9AC0CD  ctermfg=24
hi cPointerOperator         guifg=#EEAEEE  ctermfg=24
hi cLogicalOperator         guifg=#CDCD00  ctermfg=24
hi cBinaryOperator          guifg=#BBFFFF  ctermfg=24
hi cBinaryOperatorError     guifg=#C0FF3E  ctermfg=24
hi cLogicalOperator         guifg=#C0FF3E  ctermfg=24
hi cLogicalOperatorError    guifg=#C0FF3E  ctermfg=24
hi cpriorityperator	    guifg=#CDAD00  ctermfg=58

let b:current_syntax_addtion = "java"
